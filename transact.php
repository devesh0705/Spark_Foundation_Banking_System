...
<table border="0px" style="background-color:#f5f5dc;">
	...
	<td><select name="user">
		...
		<tr><td></td><td><input type="submit" name="submit" value="Submit" align=center style="margin-top: 10px; width:6em; height:2em; font-size:15px; background-color:#ECF0F1; font-weight: bold;"></td></tr>
</table>

</form>

<div class="footer">
            <p><b><h3>Enter Correct Amount.<br>Check the Correct Credit Name</h3></b>
            </p>
</div>
